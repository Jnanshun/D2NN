...
baseline_eval1.to_csv('./acc_data_nonlinear_3.csv')
baseline_eval2.to_csv('./loss_data_nonlinear_3.csv')
...
torch.save(model,'./nonlinear_3.pt')


# In[28]:


D2NN = torch.load('./nonlinear_3.pt')
D2NN
